...
public class MailController {
	...
	public String sendEmail(@PathVariable String tomail) {
	    ...
	    try {
	        ...
	        requestBody.put("subject", "RamanaSoft Attendence Portal - OTP for Password Reset");
	        requestBody.put("htmlbody", "<html>" +
	        	    "<body style='font-family: Arial, sans-serif; line-height: 1.6;'>" +
	        	    "<div style='max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;'>" +
	        	    "<h2 style='text-align: center; color: #4CAF50;'>RamanaSoft Attendance - Signup OTP</h2>" +
	        	    "<p>Hello,</p>" +
	        	    "<p>Welcome to RamanaSoft Attendance! To complete your signup process, please use the OTP below:</p>" +
	        	    ...
	        	    otp +
	        	    "</div>" +
	        	    "<p>If you did not request this signup, please ignore this email or contact our support team if you have concerns.</p>" +
	        	    "<p>Thank you,<br>RamanaSoft Team</p>" +
